...
// Escenario
// -------------------------------------------------------------------------------------------------------------------------
// Activar el shader estático correctamente antes de dibujar el escritorio
		staticShader.use();
		staticShader.setMat4("projection", projectionOp);
		staticShader.setMat4("view", viewOp);
		staticShader.setVec3("viewPos", camera.Position);

		// Configurar iluminación para staticShader
		staticShader.setVec3("dirLight.direction", lightDirection);
		staticShader.setVec3("dirLight.ambient", ambientColor);
		staticShader.setVec3("dirLight.diffuse", diffuseColor);
		staticShader.setVec3("dirLight.specular", glm::vec3(0.6f, 0.6f, 0.6f));
		...
		// Configuración y dibujado del escritorio
		...
		*/
		//3X3
		/*
		// Parámetros para distribuir los escritorios
		...
		for (int fila = 0; fila < 3; fila++) {
			...
			for (int col = 0; col < 3; col++) {
				// Calculamos el desplazamiento según la posición
